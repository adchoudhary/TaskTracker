...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditProject.aspx.cs" Inherits="_Default" %>
       ...
       <div class="container">
            ...
            <form id="form1" runat="server" class="form-horizontal">
                ...
                ErrorMessage="Estimated Cost is supposed to be a decimal" CssClass="text-error" ValidationExpression="\d*\.?\d*">*</asp:RegularExpressionValidator>
                 ...
                 <div class="control-group">
                    <asp:Label ID="Label6" runat="server" Text="Technical Section Date" CssClass="control-label"></asp:Label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <asp:Label ID="Label7" runat="server" Text="Technical Section Amount" CssClass="control-label"></asp:Label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <asp:Label ID="Label8" runat="server" Text="Administrative Section Date" CssClass="control-label"></asp:Label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <asp:Label ID="Label9" runat="server" Text="Administrative Section Amount" CssClass="control-label"></asp:Label>
                    <div class="controls">
